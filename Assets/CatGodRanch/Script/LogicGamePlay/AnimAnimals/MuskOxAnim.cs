...
public class MuskOxAnim : AnimTutBase
{
    public GameObject muskOx;
    ...
    private IEnumerator HandleShowTut()
    {
        ...
        yield return muskOx.transform.DOJump(muskOx.transform.position, 1, 1, 0.5f).WaitForCompletion();
        ...
        coin_1.transform.position = muskOx.transform.position;
        coin_2.transform.position = muskOx.transform.position;
        coin_3.transform.position = muskOx.transform.position;
        coin_4.transform.position = muskOx.transform.position;
